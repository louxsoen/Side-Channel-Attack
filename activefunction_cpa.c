...
#define startpoint 13000 	// ※ Setting ※ 13000
#define endpoint 24000	// ※ Setting ※

// 정렬 알고리즘 시작 위치 
#define startAL 13400
...
void Alignment()
{
	int windowsize = 2500; // 500 1000
	int stepsize = 10000;	//450 950
	int threshold =	1500; // 100 200
	char buf[256];
	...
	for (i = 1; i < TraceNum; i++)
	{
		...
		SubAligned(data1 + startAL, data2 + startAL, windowsize, stepsize, threshold, TraceLength - startAL); // + startAL 
